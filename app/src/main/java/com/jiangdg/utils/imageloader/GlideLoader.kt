...
// import com.bumptech.glide.integration.webp.decoder.WebpDrawable // Commented out due to dependency issues
// import com.bumptech.glide.integration.webp.decoder.WebpDrawableTransformation // Commented out due to dependency issues
...
class GlideLoader<T>(target: T) : ILoader<ImageView> {
    ...
    override fun load(imageView: ImageView, url: String?, placeHolder: Int) {
        ...
        mRequestManager!!.load(url).optionalTransform(centerCrop)
            // .optionalTransform(WebpDrawable::class.java, WebpDrawableTransformation(centerCrop)) // Commented out due to dependency issues
    ...
    override fun loadRounded(imageView: ImageView, url: String?, radius: Float) {
        loadRounded(imageView, url, android.R.drawable.ic_menu_gallery, radius)
    }
